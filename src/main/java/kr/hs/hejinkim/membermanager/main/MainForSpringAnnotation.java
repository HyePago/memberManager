...
import kr.hs.hejinkim.membermanager.config.AppCtx;
...
public class MainForSpringAnnotation {
	private static AnnotationConfigApplicationContext ctx; // static 메서드에서 일반 변수에 접근 할 수 없기 때문에, static으로 선언함.
